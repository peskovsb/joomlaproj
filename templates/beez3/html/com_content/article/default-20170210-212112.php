...
<div class="container-webka" style="margin-top: -50px;">
    <article class="<?php if ($params->get('show_hits')) : ?>container<?php endif; ?> innerWrapperDetail item-page<?php echo $this->pageclass_sfx?>">
